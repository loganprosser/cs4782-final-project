...
from bayes_by_backprop.evaluate import predict_regression_mc, save_json
from bayes_by_backprop.losses import bayesian_regression_loss
from bayes_by_backprop.models import BayesianRegressionMLP, RegressionMLP
from bayes_by_backprop.update_trust import (
    apply_update_trust_scaling,
    build_optimizer,
    get_update_trust_suffix,
    summarize_trust_logs,
)
from bayes_by_backprop.utils import ensure_dir, get_device, plot_regression_predictions, set_seed
...
DEFAULT_CONFIG = {
    ...
    "seed": 0,
    "output_dir": "results/bayes_by_backprop/regression",
    "resume_checkpoint": "",
}
