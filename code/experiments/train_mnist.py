...
from bayes_by_backprop.evaluate import evaluate_classifier, save_accuracy_table, save_json
...
from bayes_by_backprop.utils import ensure_dir, get_device, plot_training_curves, set_seed
...
DEFAULT_CONFIG = {
    ...
    "label_noise": 0.0,
    "data_dir": "data",
    "output_dir": "results/bayes_by_backprop/mnist",
    "resume_checkpoint": "",
    "quiet": False,
    "run_tag": "",
}
