...
from bayes_by_backprop.utils import set_seed
from evaluation.summarize_results import compact_plot_label, svg_multiline_text, wrap_label
...
def main() -> None:
    ...
    results_dir = root_dir / "results" / "bayes_by_backprop"
    if args.summary_dir:
