...
from kalman_trust.kalmanalgo.kalman_optimizer import KalmanGradientTrust

from bayes_by_backprop.evaluate import evaluate_classifier, save_json
from bayes_by_backprop.losses import bayesian_classification_loss
from bayes_by_backprop.utils import ensure_dir, get_device, set_seed
from experiments.train_mnist import LabelNoiseDataset, build_model, load_image_dataset
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=str, default="results/bayes_by_backprop/external_kalman_algo")
