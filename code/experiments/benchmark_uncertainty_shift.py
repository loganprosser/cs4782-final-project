...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--summary-dir", type=str, default="results/bayes_by_backprop/uncertainty_shift")
    parser.add_argument("--output-dir", type=str, default="results/bayes_by_backprop/uncertainty_shift")
